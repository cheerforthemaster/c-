...
//		for (int j = 0; j < 3; j++)
//		{
//			glVertex3f(readobj.vArr[readobj.nArr[i][j] - 1][0] * 10, readobj.vArr[readobj.nArr[i][j] - 1][1] * 10, readobj.vArr[readobj.nArr[i][j] - 1][2] * 10);
//		}
//	}
//	glEnd();
//	glEndList();
...
//		{
//			glVertex3f(readobj.vArr[readobj.nArr[i][j] - 1][0] * 10, readobj.vArr[readobj.nArr[i][j] - 1][1] * 10, readobj.vArr[readobj.nArr[i][j] - 1][2] * 10);
//			glVertex3f(readobj.vArr[readobj.nArr[i][(j + 1) % 3] - 1][0] * 10, readobj.vArr[readobj.nArr[i][(j + 1) % 3] - 1][1] * 10, readobj.vArr[readobj.nArr[i][(j + 1) % 3] - 1][2] * 10);
//		}
//	}
//	glEnd();
//	glEndList();
