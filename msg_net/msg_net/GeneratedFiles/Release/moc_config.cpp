...
#include "../../../../../../../Desktop/msg_net/msg_net/config.h"
...
QT_MOC_LITERAL(1, 7, 10), // "wrong_text"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 21) // "on_buttonBox_accepted"

    },
    "config\0wrong_text\0\0on_buttonBox_accepted"
};
...
void config::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&config::wrong_text)) {
                *result = 0;
                return;
            }
        }
