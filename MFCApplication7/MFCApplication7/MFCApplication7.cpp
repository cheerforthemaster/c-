...
BEGIN_MESSAGE_MAP(CMFCApplication7App, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CMFCApplication7App::OnAppAbout)
...
CMFCApplication7App::CMFCApplication7App()
{
	...
	SetAppID(_T("MFCApplication7.AppID.NoVersion"));
...
BOOL CMFCApplication7App::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CMFCApplication7Doc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CMFCApplication7View));
	if (!pDocTemplate)
		return FALSE;
...
// CMFCApplication7App message handlers
